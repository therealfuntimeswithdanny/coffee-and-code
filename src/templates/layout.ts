...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .more-stories { display: flex; justify-content: center; margin-top: 48px; }
    .more-stories__button { border: 1px solid var(--accent); color: var(--ink); font-size: 14px; font-weight: 700; letter-spacing: .07em; padding: 12px 18px; text-transform: uppercase; transition: background-color .2s ease, color .2s ease; }
    .more-stories__button:hover { background: var(--accent); color: var(--paper); }
