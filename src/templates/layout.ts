...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .site-header { border-bottom: 1px solid #8a5b38; background: var(--paper); }
    ...
    .lead-story .eyebrow, .archive-story .eyebrow { margin: 0 0 7px; color: var(--accent); }
    ...
    .archive-section .section-heading { border-top: 0; }
    ...
    .archive-story__image { aspect-ratio: 1.65 / 1; background: var(--paper-deep); display: block; margin-bottom: 16px; overflow: hidden; }
